...
class SplashActivity : AppCompatActivity() {
    ...
    var permissionsString = arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE,
            Manifest.permission.MODIFY_AUDIO_SETTINGS, //vizualiser uses
            Manifest.permission.READ_PHONE_STATE,  //stop music when call comes
            Manifest.permission.PROCESS_OUTGOING_CALLS,  //call incoming
