package com.example.ananyapradhan.echo.fragments
...
import com.example.ananyapradhan.echo.CurrentSongHelper
import com.example.ananyapradhan.echo.R
import com.example.ananyapradhan.echo.databases.EchoDatabase
...
class SongPlayingFragment : Fragment() {
    ...
    object Statified {
        ...
        var audioVisualization: com.cleveroad.audiovisualization.AudioVisualization? = null
    ...
    object Staticated {
        ...
        fun processInformation(mediaPlayer: MediaPlayer) {
            ...
            Statified.startTimeText?.setText(String.format("%d:%d",
                    ...
                    java.util.concurrent.TimeUnit.MILLISECONDS.toSeconds(startTime?.toLong()) - java.util.concurrent.TimeUnit.MILLISECONDS.toSeconds(java.util.concurrent.TimeUnit.MILLISECONDS.toMinutes(startTime?.toLong())))
            )

            Statified.endTimeText?.setText(String.format("%d:%d",
                    java.util.concurrent.TimeUnit.MILLISECONDS.toMinutes(finalTime?.toLong()),
                    java.util.concurrent.TimeUnit.MILLISECONDS.toSeconds(finalTime?.toLong()) - java.util.concurrent.TimeUnit.MILLISECONDS.toSeconds(java.util.concurrent.TimeUnit.MILLISECONDS.toMinutes(finalTime?.toLong())))
            )
